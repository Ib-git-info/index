...
--custom-color-1: #fb8900;
--custom-color-1-darker: #e27b00;
--custom-color-1-r: 251;
--custom-color-1-g: 137;
--custom-color-1-b: 0;
--custom-color-1-contrast: white;
--custom-color-1-contrast-darker: white;
--custom-color-1-text-color: var(--body-alt-color);
--custom-color-2: #c16be3;
--custom-color-2-darker: #b54fde;
--custom-color-2-r: 193;
--custom-color-2-g: 107;
--custom-color-2-b: 227;
--custom-color-2-contrast: white;
--custom-color-2-contrast-darker: white;
--custom-color-2-text-color: var(--body-alt-color);
--custom-color-3: #9700ee;
--custom-color-3-darker: #8800d6;
--custom-color-3-r: 151;
--custom-color-3-g: 0;
...
--custom-color-4: #deecf9;
--custom-color-4-darker: #b6d5f2;
--custom-color-4-r: 222;
--custom-color-4-g: 236;
--custom-color-4-b: 249;
--custom-color-4-contrast: black;
--custom-color-4-contrast-darker: black;
--custom-color-4-text-color: var(--body-color);
--custom-color-5: #17bdb5;
--custom-color-5-darker: #15aaa3;
--custom-color-5-r: 23;
--custom-color-5-g: 189;
--custom-color-5-b: 181;
