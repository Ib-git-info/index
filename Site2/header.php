...
<div id="page" class="site">
    ...
    <header class="u-align-center-xs u-border-1 u-border-grey-25 u-clearfix u-custom-color-4 u-header u-header" id="sec-9228">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/20210114_151310.png",
            'default_url' => home_url('/'),
            'default_width' => '189'
        )); ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo esc_url($logo['url']); ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="1280" data-image-height="1280">
      <img <?php if ($logo['svg']) {echo 'style="width:'.$logo['width'].'px"';} else {echo 'style="width:auto"';}?>src="<?php echo esc_url($logo['src']); ?>" class="u-logo-image u-logo-image-1" data-image-width="189.5">
    </a>
    <?php get_search_form(); ?>
    <?php
            ob_start();
      ...
      <div class="u-custom-menu u-nav-container-collapse">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                'container_class' => 'u-align-left u-menu u-menu-dropdown u-nav-spacing-25 u-offcanvas-shift u-menu-1',
                'menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-280a-19',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 0px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-280a-20',
                    'submenu_item_class' => 'u-nav-item',
